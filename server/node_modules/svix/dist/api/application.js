...
class Application {
    ...
    list(options) {
        ...
        request.setQueryParam("exclude_apps_with_no_endpoints", options === null || options === void 0 ? void 0 : options.excludeAppsWithNoEndpoints);
        request.setQueryParam("exclude_apps_with_disabled_endpoints", options === null || options === void 0 ? void 0 : options.excludeAppsWithDisabledEndpoints);
